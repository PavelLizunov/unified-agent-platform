...
- `desktop-m922ij2` — рабочая Windows владельца, а не test target. Hermes и его агенты не проверяют Qwen,
  не вызывают его и не выполняют команды на этом хосте без нового разрешения владельца, которое явно называет
  конкретного агента и конкретное действие. Общее разрешение на goal/live-window на этот хост не распространяется.
- Единственный Windows UAT target этого goal — отдельная VM `windows-brat`.
