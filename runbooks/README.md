...
| [hermes-flow-v2.md](hermes-flow-v2.md) | ADR-028 quota-aware Kanban contract: guarded author, cross-family read-only review, SHA/CI merge gate and terminal cleanup. | Running multi-checkpoint or longer-than-30-minute repository work through Hermes. |
