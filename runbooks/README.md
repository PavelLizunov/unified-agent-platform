...
| [hermes-agent-codex-brain.md](hermes-agent-codex-brain.md) | Deploy the in-cluster hermes-agent gateway via Flux with its Codex brain (Track A2). | Deploying or repairing the k3s hermes-agent + current Codex brain; local fallback is documented separately. |
...
| [hermes-development-readiness-goal.md](hermes-development-readiness-goal.md) | GOAL: gate-based acceptance of Hermes for maintaining multiple owner repositories. | Auditing runtime/prompts/tests and proving repo-specific development cycles before moving daily work into Hermes. |
| [hermes-flow-v2.md](hermes-flow-v2.md) | ADR-028/031 Kanban contract: autonomous OpenAI routing, guarded author, exact-SHA read-only review, CI/merge gate and cleanup. | Running multi-checkpoint or longer-than-30-minute repository work through Hermes. |
...
| [hermes-workspace-webcenter.md](hermes-workspace-webcenter.md) | hermes-workspace web command center on build-1 `:3000`, backed by central k3s hermes-agent (tailnet-only). | The user-facing central Hermes UI; build-1 remains Flow/orchestrator infrastructure. |
