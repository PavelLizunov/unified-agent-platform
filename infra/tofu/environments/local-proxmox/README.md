...
The VMs already exist at the moment. Import them into state before allowing OpenTofu to manage them, or use this
environment as the repeatable template for recreating the same topology.
