...
5. ADR-031 replaces per-attempt model approvals. Luna/Sol/Terra selection, reasoning effort, retries, normal tests/VMs,
   ...
   masked common credentials/user-runtime IPC. PR #266 and installed exact-wrapper probe are green; a real Codex
   reviewer canary is still pending. Evidence: `docs/evidence/reviewer-os-isolation-rollout-2026-07-18.md`.
