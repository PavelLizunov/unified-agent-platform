...
class DeliveryCoordinator:
    ...
    def _author(self, state: dict[str, Any], paths: dict[str, pathlib.Path]) -> bool:
        ...
        prompt = (
            ...
            "use the smallest native implementation. Before editing, read every source explicitly required by the goal. "
            "If a required source is unavailable, do not create substitute files or inferred content; leave the worktree "
