...
| `swarm` | Kanban watchdog plus ADR-028 quota-aware routing, repository guards, SHA-bound review and terminal-state validation. | `python tools/swarm/flow_contract.py --help`; watchdog cron remains on build-1 | [hermes-flow-v2.md](../runbooks/hermes-flow-v2.md) | `python tests/static/test_hermes_flow_contract.py` |
